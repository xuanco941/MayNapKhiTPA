...
Employee_Password VARCHAR(100) default 'Leanway',
...
Result_ApSuat FLOAT,
Result_TheTich FLOAT,
Result_LuuLuong FLOAT,
Result_ThoiGianNap Time,
...
CREATE PROC UpdateEmployee @UsernameOld varchar(100), @FullName nvarchar(100), @Username VARCHAR(100) , @Password VARCHAR(100), @Department NVARCHAR(100) , @IsAdmin Bit
as begin
...
where Employee_Username = @UsernameOld
end
GO
...
as begin
Delete FROM Employee WHERE Employee.Employee_Username = @username;
end
GO
